...
const { makeNotesArray, makeNewNote, makeUpdatedNote, makeShamNote } = require('./notes-fixtures');
...
describe(`Notes Endpoints`, function(){
    ...
    describe(`POST /api/notes`, () => {
        ...
        before('insert folders and notes', () => { //change to beforeeach if more tests are added for post
            return db
             .into('folders')
             .insert(testFolders)
        });
    ...
    describe(`DELETE /api/notes`, () => {
        ...
        context(`Given notes in the database`, () => {
            ...
            it(`responds with 200 when note in database is deleted`, () => {
                ...
                const remainingNotes = testNotes.filter(note => {note.id !== deleteNoteId});
